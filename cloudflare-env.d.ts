/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: 52a98f9f98520ee8d32689759b8eb762)
...
interface __BaseEnv_CloudflareEnv {
	...
	ASSETS: Fetcher;
	CLOUDFLARE_ACCOUNT_ID: "68799315c4e277e252cf254bba0e7d2b";
	NEXTJS_ENV: string;
	SUPABASE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ACCOUNT_ID" | "NEXTJS_ENV" | "SUPABASE_URL" | "SUPABASE_PUBLISHABLE_KEY" | "SUPABASE_SECRET_KEY">> {}
}
