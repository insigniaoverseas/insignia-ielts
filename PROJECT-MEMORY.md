...
| **Next task** | **M0-08** content & assignment migration ([`BUILD-STEPS.md`](BUILD-STEPS.md) step 16): `tests`, `band_scales`, `band_scale_rows`, `assignments`, `assignment_targets`, `assignment_unlocks`. Same workflow. No-DB tasks that can run alongside: M0-12 part 1 (R2 buckets), M0-13 (CSP), M0-15 (`question-types.ts`), M0-18 (`scoring.ts`), M0-21 (docs). |
