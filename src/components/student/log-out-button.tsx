 ...
 * a student takes by accident and then cannot undo without their PIN — so it
 * asks first, and names what will happen.
 *
	...
	return (
		<>
			...
			<ConfirmDialog
				...
				description="You'll need your phone number and PIN to get back in. Your answers and results are saved."
